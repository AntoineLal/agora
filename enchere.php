...
if (!isset($_SESSION['user_id']) || $_SESSION['usertype'] !== 'buyer') {
    header("Location: arreter_enchere.php");
    exit();
}
...
<?php if (isset($_SESSION['usertype']) && $_SESSION['usertype'] === 'seller' && $current_time <= $end_time): ?>
    <form action="arreter_enchere.php" method="post">
